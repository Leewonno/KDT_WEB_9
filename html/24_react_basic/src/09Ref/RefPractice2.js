    ...
    return (
        <>
            <form>
                ...
                <input type="text" id="writer" value={inputWriter} onChange={(e) => onChange(e)} ref={myInput} / >
                <label htmlFor="title">제목:</label>
                <input type="text" id="title" value={inputTitle} onChange={(e) => setInputTitle(e.target.value)} ref={myInput2} />
